...
import designpatterns.decorator.TextLinesFactoryTrimDecorator;
...
public class TextClassifierImplTest {
    ...
    public void testClassifyFromFile() {
        ...
        TextLinesFactory textLinesFactory = new InMemoryTextLinesFactory(
                "  123  ", " pattern-test ", "    ", " tacocat ");

        textLinesFactory = new TextLinesFactoryTrimDecorator(textLinesFactory);
